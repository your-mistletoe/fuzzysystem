...
# 사용자 그림 이미지
image = cv2.imread("img/23323.jpg")
...
# 규칙 후건의 통합 : 그래프용
aggregated1 = np.fmax(gr1_rule1, np.fmax(gr1_rule2, np.fmax(gr1_rule3, np.fmax(gr1_rule3_1, np.fmax(gr1_rule3_2, np.fmax(gr1_rule3_3, np.fmax(gr1_rule4, np.fmax(gr1_rule5, np.fmax(gr1_rule6, np.fmax(gr1_rule6_1, np.fmax(gr1_rule6_2, np.fmax(gr1_rule7, np.fmax(gr1_rule7_1,  np.fmax(gr1_rule7_2, np.fmax(gr1_rule8, gr1_rule8_1)))))))))))))))
...
gr2_rule6_1 = np.fmin(DC1_rule6_1, GREEN)
gr2_rule6_2 = np.fmin(DC1_rule6_2, GREEN)
gr2_rule7 = np.fmin(DC1_rule7, BLUE)
gr2_rule7_1 = np.fmin(DC1_rule7_1, BLUE)
gr2_rule7_2 = np.fmin(DC1_rule7_2, BLUE)
gr2_rule8 = np.fmin(DC1_rule8, PURPLE)
gr2_rule8_1 = np.fmin(DC1_rule8_1, PURPLE)

aggregated2 = np.fmax(gr2_rule1, np.fmax(gr2_rule2, np.fmax(gr2_rule3, np.fmax(gr2_rule3_1, np.fmax(gr2_rule3_2, np.fmax(gr2_rule3_3, np.fmax(gr2_rule4, np.fmax(gr2_rule5, np.fmax(gr2_rule6, np.fmax(gr2_rule6_1, np.fmax(gr2_rule7,  np.fmax(gr2_rule7_1, np.fmax(gr2_rule7_2, np.fmax(gr2_rule8, gr2_rule8_1))))))))))))))
